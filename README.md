...
| OWASP Top 10-2021 | Easy | 2025-03-18 | Introduction, Accessing Machines, Broken Access Control, Broken Access Control (IDOR Challenge), Cryptographic Failures, Cryptographic Failures (Supporting Material 1), Cryptographic Failures (Supporting Material 2), Cryptographic Failures (Challenge), Injection, Command Injection, Insecure Design, Security Misconfiguration, Vulnerable and Outdated Components, Vulnerable and Outdated Components - Exploit, Vulnerable and Outdated Components - Lab, Identification and Authentication Failures, Identification and Authentication Failures Practical, Software and Data Integrity Failures, Software Integrity Failures, Data Integrity Failures, Security Logging and Monitoring Failures, erver-Side Request Forgery (SSRF), What Next?.
...
| Security Principles | Easy | 2025-04-01 |
| Training Impact on Teams | Easy | 2025-04-01 |
## 🎯 Next Steps & Goals  
